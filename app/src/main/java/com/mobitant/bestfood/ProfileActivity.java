...
public class ProfileActivity extends AppCompatActivity implements View.OnClickListener {
	...
	private void setView() {
		...
		birthEdit = findViewById(R.id.profile_birth);
		...
		phoneEdit = findViewById(R.id.profile_phone);
		phoneEdit.setText(phoneNumber);
		
		TextView phoneStateEdit = findViewById(R.id.phone_state);
	...
	/**
	 * 오른쪽 상단 메뉴를 구성한다.
	 * 닫기 메뉴만이 설정되어 있는 menu_close.xml을 지정한다.
	 *
	 * @param menu 메뉴 객체
	...
	private void save() {
		...
		MyLog.d(TAG, "insetItem " + newItem.toString());
